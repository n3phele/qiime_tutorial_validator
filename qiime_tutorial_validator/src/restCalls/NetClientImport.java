...
public class NetClientImport {
	...
	public void importCommand(String nameFile){
		try {
			...
			post.addHeader("Authorization","Basic bmlnZWwuY29vay5hdC0uaHAuY29tOmZvb2Jhcg==");
			MultipartEntity entity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE);
			
			File fileName = new File("C:/Users/Lis/Desktop/scripts/"+nameFile);
			// For File parameters
